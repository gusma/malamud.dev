				...
				<div id='main' className='uses'>
					<section id='one'>
						<div className='inner'>
							...
							<h3>iTerm 2 + <Link to='https://fig.io'>Fig</Link></h3>
							<p>iTerm is your trusty non-standard terminal tool for Mac, tuned for great performance. And <b>Fig</b> in this case constitutes the steroids: Still in beta, it hands excellent options for autocompleting your shell commands, giving your terminal a full power up. Try it!</p>
							<p>
